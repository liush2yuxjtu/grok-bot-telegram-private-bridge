...
export function buildAirtableTaskNotificationPrompt({ recordId, eventId }) {
  return [
    ...
    "",
    "Required protocol:",
    "1. Fetch EXACTLY that record from the fixed Airtable base/table. Prefer your connected Airtable tool/connector. If no Airtable connector is available, use an already-authenticated browser session to open that fixed base/table and locate exactly this record ID. Do not search for other queued work.",
    ...
    "6. If Airtable cannot be read or updated through a connector or already-authenticated browser, or if login, consent, CAPTCHA, destructive/irreversible action, or another genuine human boundary is required: do not poll. If you can update the row, set Status=Needs Human and write the exact single required action to Blocker; otherwise report the single blocker in your final turn.",
